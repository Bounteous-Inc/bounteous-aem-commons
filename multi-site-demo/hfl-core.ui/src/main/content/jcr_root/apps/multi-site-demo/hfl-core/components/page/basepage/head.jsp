...
%><head>
    ...
    <% } %>
    <title><%= currentPage.getPageTitle() == null ? (currentPage.getTitle() == null ? xssAPI.encodeForHTML(currentPage.getName()) : xssAPI.encodeForHTML(currentPage.getTitle())) : xssAPI.encodeForHTML(currentPage.getPageTitle()) %></title>
</head>