...
public class Constants {
    ...
    public static String RESOURCE_TYPE_IMAGE_HIDDEN_TYPE = "core/wcm/components/image/v2/image";
    ...
    public static String DIALOG_TYPE_SHARED = "dialogshared";
    public static String FILENAME_CONTENT_XML = ".content.xml";

    public static String PROPERTY_TYPE_PRIVATE = "private";
